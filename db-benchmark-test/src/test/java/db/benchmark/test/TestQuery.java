...
public class TestQuery {
    ...
    public static final String NEO4J_QUERY_FN_7 = QUERY_HOLDER.getProperty("neo4j.query.fn.7");
    public static final String MYSQL_QUERY_FN_7 = QUERY_HOLDER.getProperty("mysql.query.fn.7");
}