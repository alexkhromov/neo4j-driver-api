...
BEGIN
    ...
    WHILE CONTROLLER_COUNT_CURRENT <= CONTROLLER_COUNT DO
        ...
        WHILE LOCATION_AREA_COUNT_CURRENT <= LOCATION_AREA_COUNT DO
            INSERT INTO LOCATION_AREA ( CONTROLLER_ID, NAME ) VALUES ( LAST_CONTROLLER_ID, CONCAT( 'LA', LOCATION_AREA_COUNT_CURRENT ) );
            ...
            WHILE CELL_COUNT_CURRENT <= CELL_COUNT DO
                INSERT INTO CELL ( LOCATION_AREA_ID, NAME ) VALUES ( LAST_LOCATION_AREA_ID, CONCAT( 'Cell', CELL_COUNT_CURRENT ) );
