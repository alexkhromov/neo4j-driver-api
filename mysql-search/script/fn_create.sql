...
BEGIN
        ...
        WHILE (LOCATE(',', @NAMES_CURRENT_F2) > 0) DO
            ...
            WHILE (LOCATE(',', @NAMES_CURRENT_F3) > 0) DO
                ...
                WHILE (LOCATE(',', @NAMES_CURRENT_F4) > 0) DO
                    ...
                    INSERT INTO FRIEND (NAME) VALUES (CONCAT(@NAME_CURRENT_F4, FRIEND_COUNT_CURRENT, '-', FRIEND_COUNT_CURRENT,
                    '-', FRIEND_COUNT_CURRENT, '-', FRIEND_COUNT_CURRENT));
                    ...
                    WHILE (LOCATE(',', @NAMES_CURRENT_F5) > 0) DO
                        ...
                        INSERT INTO FRIEND (NAME) VALUES (CONCAT(@NAME_CURRENT_F5, FRIEND_COUNT_CURRENT, '-', FRIEND_COUNT_CURRENT,
                        ...
                        WHILE (LOCATE(',', @NAMES_CURRENT_F6) > 0) DO
                            ...
                            INSERT INTO FRIEND (NAME) VALUES (CONCAT(@NAME_CURRENT_F6, FRIEND_COUNT_CURRENT, '-', FRIEND_COUNT_CURRENT,
                            '-', FRIEND_COUNT_CURRENT, '-', FRIEND_COUNT_CURRENT, '-', FRIEND_COUNT_CURRENT));
    ...
    INSERT INTO FRIENDS (FRIEND_OF, FRIEND_TO)
        SELECT FRIEND_OF.ID, FRIEND_TO.ID FROM FRIEND AS FRIEND_OF, FRIEND AS FRIEND_TO
        WHERE REGEXP_LIKE(FRIEND_OF.NAME, '^[a-zA-Z]+([0-9]{1,2}|-){5}$') AND
              REGEXP_LIKE(FRIEND_TO.NAME, '^[a-zA-Z]+([0-9]{1,2}|-){5}$') AND
              REGEXP_SUBSTR(FRIEND_OF.NAME, '([0-9]{1,2}|-){5}$') =
              REGEXP_SUBSTR(FRIEND_TO.NAME, '([0-9]{1,2}|-){5}$')
        AND FRIEND_OF.NAME NOT LIKE FRIEND_TO.NAME AND FRIEND_OF.ID < FRIEND_TO.ID;
    COMMIT;
    ...
    INSERT INTO FRIENDS (FRIEND_OF, FRIEND_TO)
        SELECT FRIEND_OF.ID, FRIEND_TO.ID FROM FRIEND AS FRIEND_OF, FRIEND AS FRIEND_TO
        WHERE REGEXP_LIKE(FRIEND_OF.NAME, '^[a-zA-Z]+([0-9]{1,2}|-){7}$') AND
              REGEXP_LIKE(FRIEND_TO.NAME, '^[a-zA-Z]+([0-9]{1,2}|-){7}$') AND
              REGEXP_SUBSTR(FRIEND_OF.NAME, '([0-9]{1,2}|-){7}$') =
              REGEXP_SUBSTR(FRIEND_TO.NAME, '([0-9]{1,2}|-){7}$')
        AND FRIEND_OF.NAME NOT LIKE FRIEND_TO.NAME AND FRIEND_OF.ID < FRIEND_TO.ID;
    COMMIT;
    ...
    INSERT INTO FRIENDS (FRIEND_OF, FRIEND_TO)
        SELECT FRIEND_OF.ID, FRIEND_TO.ID FROM FRIEND AS FRIEND_OF, FRIEND AS FRIEND_TO
        WHERE REGEXP_LIKE(FRIEND_OF.NAME, '^[a-zA-Z]+([0-9]{1,2}|-){9}$') AND
              REGEXP_LIKE(FRIEND_TO.NAME, '^[a-zA-Z]+([0-9]{1,2}|-){9}$') AND
              REGEXP_SUBSTR(FRIEND_OF.NAME, '([0-9]{1,2}|-){9}$') =
              REGEXP_SUBSTR(FRIEND_TO.NAME, '([0-9]{1,2}|-){9}$')
        AND FRIEND_OF.NAME NOT LIKE FRIEND_TO.NAME AND FRIEND_OF.ID < FRIEND_TO.ID;
    COMMIT;
END #
